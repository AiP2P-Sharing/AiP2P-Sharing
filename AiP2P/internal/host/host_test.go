...
func TestNewDefaultsVersionLabel(t *testing.T) {
	instance, err := New(context.Background(), Config{})
	if err != nil {
		t.Fatalf("new host: %v", err)
	}
	if instance.config.Version != version.Current {
		t.Fatalf("version = %q, want %q", instance.config.Version, version.Current)
	}
}

func TestNewUsesAppConfigVersionWhenUnset(t *testing.T) {
	root := t.TempDir()
	writeHostFile(t, root, "aip2p.app.json", "{\n  \"id\": \"sample-news\",\n  \"name\": \"Sample News\",\n  \"plugins\": [\"sample-content\"],\n  \"theme\": \"sample-theme\"\n}\n")
	writeHostFile(t, root, "aip2p.app.config.json", "{\n  \"project\": \"sample.project\",\n  \"version\": \"sample-app-v1\"\n}\n")
	writeHostFile(t, root, filepath.Join("plugins", "sample-content", "aip2p.plugin.json"), "{\n  \"id\": \"sample-content\",\n  \"name\": \"Sample Content\",\n  \"base_plugin\": \"news-demo-content\",\n  \"default_theme\": \"sample-theme\"\n}\n")
	writeHostFile(t, root, filepath.Join("themes", "sample-theme", "aip2p.theme.json"), "{\n  \"id\": \"sample-theme\",\n  \"name\": \"Sample Theme\",\n  \"supported_plugins\": [\"sample-content\"],\n  \"required_plugins\": [\"sample-content\"]\n}\n")
	writeHostFile(t, root, filepath.Join("themes", "sample-theme", "templates", "home.html"), "home\n")
	writeHostFile(t, root, filepath.Join("themes", "sample-theme", "templates", "post.html"), "post\n")
	...
	if instance.config.Version != "sample-app-v1" {
		t.Fatalf("version = %q", instance.config.Version)
	}
}
